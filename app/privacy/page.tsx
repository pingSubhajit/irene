...
export const metadata: Metadata = {
	title: 'Irene - Privacy Policy',
	description: 'Read the privacy policy of Irene to understand how we collect, use, and protect your personal ' +
		'information. Irene is a simple, mobile-first, finance app to record your incomes and expenses that values your privacy.',
	keywords: [
		'Irene', 'privacy policy', 'data protection', 'personal information', 'data security', 'user privacy',
	...
	return (
		<main className="flex flex-col items-start justify-center gap-8">
			...
			<div className="prose lg:prose-xl prose-neutral prose-invert">
				...
				<p>Welcome to Irene. We are committed to protecting your privacy. This Privacy Policy explains how Irene (&quot;we,&quot; &quot;us,&quot; &quot;our&quot;) collects, uses, discloses, and safeguards your information when you use our simple, mobile-first, finance app to record your incomes and expenses.</p>
				<h2 id="2-company-information">2. Company Information</h2>
				<ul>
					<li><strong>Company Name:</strong> Irene</li>
				...
				<p>Irene uses Google OAuth to log users in. During this process, we collect the following data:</p>
				<ul>
				...
				<p>Irene does not use cookies or other tracking technologies. There is no onboarding or tracking involved in our application.</p>
				<h2 id="8-third-party-services">8. Third-Party Services</h2>
				<p>Irene does not integrate any third-party services other than Google OAuth for user authentication.</p>
				<h2 id="9-children-s-privacy">9. Children’s Privacy</h2>
				<p>Irene is not primarily intended for children. We do not knowingly collect any personal information from children under the age of 13. If we become aware that we have collected personal information from a child under 13, we will take steps to delete such information from our files as soon as possible.</p>
				...
				<p>By using Irene, you consent to our Privacy Policy.</p>
			</div>
		</main>
	)
}
