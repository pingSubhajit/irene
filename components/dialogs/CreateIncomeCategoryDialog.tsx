...
import {addIncomeCategoryToDB} from '@/lib/incomeCategory.methods'
...
const CreateIncomeCategoryDialog = ({open, setOpen}: { open: boolean, setOpen: (isOpen: boolean) => void }) => {
	...
	const onSubmit = async (values: z.infer<typeof formSchema>) => {
		try {
			...
			const category = (await addIncomeCategoryToDB({
				...values,
				userId: user!.id
			}))[0]
		...
		<Credenza open={open} onOpenChange={setOpen}>
			<CredenzaContent>
				<CredenzaHeader>
					...
					<CredenzaDescription>
						Create a new category to associate with your incomes.
					</CredenzaDescription>
				</CredenzaHeader>
...
export default CreateIncomeCategoryDialog
