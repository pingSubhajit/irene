...
import {useSingleIncomeDialog} from '@/components/providers/dialog-provider'
...
const IncomeCard = ({income, className}: {
	...
	const {setIsSingleIncomeDialogOpen} = useSingleIncomeDialog()

	return (
		<button onClick={() => setIsSingleIncomeDialogOpen(true, income as any)} className="w-full">
